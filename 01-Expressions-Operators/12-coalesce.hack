...
// Otherwise, e2 is evaluated, and its value becomes the result. There is a sequence point after the evaluation of e1.
<<__EntryPoint>>
function main(): void {
    $nully = null;
    $nonnull = 'a string';
...
// It is important to note that the right-hand side of the ?? operator will be conditionally evaluated. 
// If the left-hand side is defined and not null, the right-hand side will not be evaluated.
$nonnull = 4;
