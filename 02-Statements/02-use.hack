// The use statement permits names defined in one namespace to be introduced into another namespace, 
// so they can be referenced there by their simple name rather than their (sometimes very long) fully qualified name. 
// The use statement can only be present at the top level.
namespace UseNS {
